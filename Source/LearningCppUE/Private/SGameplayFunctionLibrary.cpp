...
// MDJ: OnActorOverlap (used by our MagicProjectile), like many other functions (line trace, impact), has a FHitResult we can use
//		FHitResult is super useful struct, CTRL+click to see what's inside of it (ImpactPoint, Normal, BoneName, ...) 
